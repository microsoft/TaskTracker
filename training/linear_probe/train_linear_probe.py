...
MODEL = "llama3_70b"
OUTPUT_DIR = "/share/projects/TaskTracker/training/linear_probe/" + MODEL 
os.makedirs(OUTPUT_DIR,exist_ok=True)

current_dir = '/share/projects/TaskTracker'
sys.path.append(current_dir)
from training.dataset import ActivationsDatasetDynamic, ActivationsDatasetDynamicPrimaryText
from training.helpers.data import load_file_paths
from training.utils.constants import CONSTANTS_ALL_MODELS, OOD_POISONED_FILE

MODEL = 'mistral'

LAYERS_PER_MODEL = {
    'llama3-70b': [0, 7, 15, 23, 31, 39, 47, 55, 63, 71, 79 ],
    'phi3': [0, 7, 15, 23, 31],
