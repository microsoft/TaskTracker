...
def format_prompts(dataset_items: List, with_priming: bool = True):
    """
    ...
    - with_priming (bool, optional): Whether to include the priming instructions. Default is True.
    ...
    - Lists of:
        ...
        - batch_clean: clean text only (without additional instructions to state instructions)
        - batch_poisoned: poisoned text (without additional instructions to state instructions)
    """
    ...
    for dataset_item in dataset_items:
        ...
        batch_clean.append(dataset_item["orig_text"])
        batch_poisoned.append(dataset_item["final_text_paragraph"])
    return (
        batch_primary,
        batch_primary_clean,
        batch_primary_poisoned,
