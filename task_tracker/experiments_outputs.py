...
MODELS_RESPONSE_OUT_FILENAME_PER_MODEL = {
    ...
    + "/mistral_responses/dataset_out_poisoned_test_mistral_response.json",
    "mixtral": text_dataset_parent_dir
...
VERIFIER_RESPONSE_OUT_FILENAME_PER_MODEL = {
    "mistral": text_dataset_parent_dir
    + "/mistral_responses/dataset_out_poisoned_test_mistral_response_verifier.json",
    "mixtral": text_dataset_parent_dir
